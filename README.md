...
Developer setup, tests, and coverage live in [DEVELOPMENT.md](./DEVELOPMENT.md).

This project is generated by AI with heavy steering from me, a human. See [I don't want your PRs anymore](https://dpc.pw/posts/i-dont-want-your-prs-anymore/) for this project's contribution philosophy. Follow the guidance in [How can you help instead](https://dpc.pw/posts/i-dont-want-your-prs-anymore/#how-can-you-help-instead).
